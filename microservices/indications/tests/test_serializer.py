...
from grpcService.protobufs.indications_pb2 import PostIndicationTypeRequest, PostIndicationRequest
...
@pytest.mark.parametrize("indication", [
    PostIndicationRequest(indication=1, indicationsTypeID='1', createdAt=Date(day=1, month=1, year=1970)),
])
